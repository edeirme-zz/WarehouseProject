...
<div id="login2">
        ...
        <form id="form1" name="form1" action="<%= response.encodeURL("registerUser")%>" method="GET" onsubmit="return validateForm();">

            <fieldset>

                <p><label for="username">Username</label></p>
                <p><input type="text" id="username" class="text" name="username"value="" placeholder="Username"required></p>
                <p><label for="password">Password</label></p>
                <p><input type="password" id="password" name="password" value="" placeholder="Password"required></p>
                <p><label for="repeatpassword">Repeat Password</label></p>
                
        <p><input type="password" name="cpassword" id="cpassword" value="" placeholder="Repeat Password"required onblur="confirmPass()"></p>
        
                 <p><label for="firstname">First Name</label></p>
                <p><input type="text" class="text" id="firstname" name="firstname" value="" placeholder="First Name"required></p> 
                <p><label for="lastname">Last Name</label></p>
                <p><input type="text"  class="text" id="lastname" name="lastname" value="" placeholder="Last Name"required></p>   
                <p><label for="email">E-mail address</label></p>
                <p><input type="email" id="email" name="email" value="" placeholder="Email Address"required></p>   <%if(u!=null){ if(u.getRolerole()>0) { %>
