...
<div id="login2">
        ...
        <h2><span class="fontawesome-lock"></span>Add Provider</h2>

        <form action="<%= response.encodeURL("registerProvider")%>" method="POST">

            <fieldset>

                <p><label for="prvname">Provider Name</label></p>
                <p><input type="text" id="warehouse" name="provname"  class="text" value="" placeholder="Provider Name"required></p> <!-- JS because of IE support; better: placeholder="mail@address.com" -->
  
                <p><label for="pdescr">Address</label></p>
                <p><input type="text" id="warehousedescr" name="provaddress" class="text" value="" placeholder="Address"required></p>
                <p><label for="ptype">Social Security Number</label></p>
                <p><input type="number" id="warehousedescr" name="ssn"  class="text"value="" placeholder="Security Number"required></p>
